      ...
      <div class="container grid-lg">
        ...
        <div class="columns">
          <div class="column col-3 col-xs-12">
            <div class="card">
              <div class="card-body">
                To promote research, provide professional development, and identify developmental
          ...
          <div class="column col-3 col-xs-12">
            <div class="card">
              <div class="card-body">
                To promote scientific information interchange between researchers, health
                professionals, developers, engineers, and practitioners.
              </div>
            </div>
          </div>
          <div class="column col-3 col-xs-12">
            <div class="card">
              <div class="card-body">
                To showcase our excellent multidisciplinary team-based research endeavours in
                Queensland to academics, international students, industry, and investment markets in
                key Asia countries.
              </div>
            </div>
          </div>
